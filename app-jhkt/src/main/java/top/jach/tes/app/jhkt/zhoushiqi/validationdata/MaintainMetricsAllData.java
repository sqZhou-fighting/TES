...
public class MaintainMetricsAllData extends DevApp {
    public static void main(String[] args) {
        ...
        for (Version version : versionsInfoForRelease.getVersions()) {
            ...
            row00.createCell(10).setCellValue("Coupling - Avg Number Of Connected Services Directl");
            row00.createCell(11).setCellValue("Coupling - IncomingCouplingOfSByDependency");
            row00.createCell(12).setCellValue("Coupling - OutgoingCouplingOfSByDependency");
            row00.createCell(13).setCellValue("Coupling - TotalCouplingOfSByDependency");
            row00.createCell(14).setCellValue("Coupling - IncomingCouplingOfSByDependencyAndParams");
            row00.createCell(15).setCellValue("Coupling - OutgoingCouplingOfSByDependenyAndParams");
            row00.createCell(16).setCellValue("Coupling - TotalCouplingOfSByDependencyAndParams");

            row00.createCell(17).setCellValue("Cohesion - Service Interface Data Cohesion");
            row00.createCell(18).setCellValue("Cohesion - Service Interface Usage Cohesion");
            row00.createCell(19).setCellValue("Cohesion - Total Interface Cohesion of a Service");
            ...
            Map<String, Double> avgNumberOfConnectedServicesDirectly = CouplingMetrics.avgNumberOfConnectedServicesDirectly(inAndOutDegree.getInDegree(), inAndOutDegree.getOutDegree(), microservicesInfo.getMicroservices().size());
            ...
            for (Microservice microservice : microservicesInfo.getMicroservices()) {
                ...
                row_service.createCell(10).setCellValue(avgNumberOfConnectedServicesDirectly.get(msName));
                row_service.createCell(11).setCellValue(MyCouplingMetricsDependency.incomingCouplingOfSByDependency(dependencies, msName));
                row_service.createCell(12).setCellValue(MyCouplingMetricsDependency.outgoingCouplingOfSByDependency(dependencies, msName));
                row_service.createCell(13).setCellValue(MyCouplingMetricsDependency.totalCouplingOfSByDependency(dependencies, msName));
                row_service.createCell(14).setCellValue((MyCouplingMetricsDependencyAndParams.incomingCouplingOfSByDependencyAndParams(msName, dependencies, topics)));
                row_service.createCell(15).setCellValue((MyCouplingMetricsDependencyAndParams.outgoingCouplingOfSByDependencyAndParams(msName, dependencies, topics)));
                row_service.createCell(16).setCellValue((MyCouplingMetricsDependencyAndParams.totalCouplingOfSByDependencyAndParams(msName, dependencies, topics)));

                row_service.createCell(17).setCellValue((CohesionMetrics.SIDC(microservice)));
                row_service.createCell(18).setCellValue((CohesionMetrics.SIUC(microservice, dependenciesInfo.getDependencies())));
                row_service.createCell(19).setCellValue((CohesionMetrics.TICS(microservice, dependenciesInfo.getDependencies())));

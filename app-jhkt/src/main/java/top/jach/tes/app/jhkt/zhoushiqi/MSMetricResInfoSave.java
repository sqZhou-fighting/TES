 ...
 * @description:
 */
public class MSMetricResInfoSave extends DevApp {
...
//        DecimalFormat df = new DecimalFormat("0.0000");
        ...
        for (Version version : versionsInfoForRelease.getVersions()) {
            ...
            MSMetricResInfo msMetricResInfo = MSMetricResInfo.createInfoByMsMetricRes(version.getVersionName(),
                    msMetricRess);
            msMetricResInfo.setName(InfoNameConstant.MSMetricRes);
            InfoTool.saveInfos(msMetricResInfo);
        }
    }
}

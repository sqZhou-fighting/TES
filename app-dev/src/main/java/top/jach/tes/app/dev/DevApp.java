...
import top.jach.tes.plugin.tes.code.git.commit.*;
...
public abstract class DevApp {
    ...
    private static void addGitCommitInfoRepository(){
        ...
        MongoCollection diffFilesCollection = mongoClient.getDatabase("tes_dev").getCollection("diff_files");
        DiffFileRepository dfRepository = new DiffFileMongoRepository(diffFilesCollection);
        gitCommitRepository = new GitCommitMongoReository(commitsCollection, dfRepository);
